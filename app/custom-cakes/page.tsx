              ...
              <section className="flex flex-col gap-4 items-center">
                ...
                <div className="grid grid-cols-4 gap-6 max-md:grid-cols-2">
                  ...
                  <div className="relative">
                    <Image
                      src={
                        "https://images.unsplash.com/photo-1582979512210-99b6a53386f9?q=80&w=774&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                      }
                      width={150}
                      height={150}
                      alt="orange"
